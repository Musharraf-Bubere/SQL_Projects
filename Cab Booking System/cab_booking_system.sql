...
-- Drivers Records
INSERT INTO Drivers (Name, PhoneNumber, LicenseNumber, Rating, JoiningDate) 
VALUES
...
-- Cabs Records
INSERT INTO Cabs (DriverID, VehicleType, VehicleNumber, Capacity) 
VALUES
(1, 'Sedan', 'MH01C1001', 4),
(2, 'SUV', 'MH01C1002', 6),
...
-- Bookings Records
INSERT INTO Bookings (CustomerID, DriverID, CabID, PickupLocation, DropoffLocation, BookingTime, Status, CancellationReason) 
VALUES
...
-- TripDetails Records
INSERT INTO TripDetails (BookingID, StartTime, EndTime, DistanceKM, Fare, WaitingTime) 
VALUES
...
-- Feedback Records
INSERT INTO Feedback (BookingID, CustomerID, DriverID, Rating, Comments, FeedbackDate) 
VALUES
